...
public interface SubCategoryRepository extends JpaRepository<SubCategory, Long> {
	...
	@Query("select new com.expense.tracker.expensetracker.response.dto.SubCategoryResponse(subCat.id,subCat.name,subCat.createdAt,subCat.updatedAt) from SubCategory subCat  where subCat.category.id = :categoryId and subCat.category.user.id = :userId")
